...
|**T03** - Administração de Usuários|**EP08** - Gerenciar usuários do sistema.|**US33** - Eu, como usuário, gostaria de visualizar os perfis de outros usuários, quando o mesmo for selecionado.|Deve haver uma pre-visualização ao passar do mouse na foto do usuário.|3|3|2|8|
|**T03** - Administração de Usuários|**EP08** - Gerenciar usuários do sistema.|**US34** - Eu, como usuário, gostaria de personalizar e adicionar uma foto ao meu perfil para outros usuários me identificarem.|Deve ser possível adicionar fotos.|3|3|2|8|
